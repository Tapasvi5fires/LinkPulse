...
export default function LoginPage() {
    ...
    useEffect(() => {
        setMounted(true);
        // Instant check - if already logged in, skip the wait
            ...
            <div className="flex-1 flex items-center justify-center p-8 lg:p-12 bg-[#020617]">
                <div className="w-full max-w-[400px] space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.05] transition-all text-xs font-semibold text-slate-300">
