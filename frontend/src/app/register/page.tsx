...
export default function RegisterPage() {
    ...
    useEffect(() => {
        setMounted(true);
        // Check if token exists in URL (social login redirect)
            ...
            <div className="flex-1 flex items-center justify-center p-8 lg:p-12 bg-[#020617]">
                <div className="w-full max-w-[400px] space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-bold"><span className="bg-[#020617] px-4 text-slate-600">Or use email</span></div>
                    </div>
